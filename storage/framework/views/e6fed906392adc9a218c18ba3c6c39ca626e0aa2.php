...
<?php $component->withAttributes([]); ?>
    ...
    <section class="px-6 py-8">
     <main class="max-w-6xl mx-auto mt-8 lg:mt-20 space-y-6">
        <article class="max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10">
            <div class="col-span-4 lg:text-center lg:pt-4 mb-10">
                <img src="<?php echo e(asset('storage/' . $post->thumbnail)); ?>" alt="" class="rounded-xl bg-blue-500" style="max-width: auto;">
                ...
                <div class="flex items-center lg:justify-center text-sm mt-4">
                    <img src="/images/mslogo.png" alt="mslogo" style="max-width: 10%;" class="rounded-xl">
...
<?php endif; ?>
                ...
                <div class="space-y-4 lg:text-lg leading-loose"><?php echo $post->body; ?></div>
            </div>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\Laravel_Projects\Mutisya_blog\resources\views/posts/show.blade.php ENDPATH**/ ?>